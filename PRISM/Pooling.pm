...
formula maxCoinage = max(r1*age1*solution1,
			 r4*age4*solution4);
...
module agent1
	...
	// Solution search
	[election] eligibile -> p:(solution1'=1)&(age1'=min(age1+agechange,ageLimit)) 
			        + 1-p:(age1'=min(age1+agechange,ageLimit));
	[election] !eligibile -> (age1'=age1+agechange);
